...
public class H5ViewActivity extends Activity {
    ...
    public void webinit() {
        ...
        switch (msg){
            case "1"://投资连图
                str = URL + "?KeyNo=" + KeyNo + "&regno=" + regno + "&entname=" + entname + "&devicetype=1&provinceCode="+CompanyDetailsActivity.ProvinceCode;
                break;
            case "2"://发展历程
                str=URL+"?KeyNo=" + KeyNo+ "&regno=" + regno+"&devicetype=1"+"&priptype="+priptype+"&provinceCode="+CompanyDetailsActivity.ProvinceCode;
                break;
            case "3"://招投标
                str = URL + "?KeyNo=" + KeyNo + "&pripid=" + pripid + "&regno=" + regno + "&priptype=" + priptype + "&entname=" + entname + "&devicetype=1&provinceCode="+CompanyDetailsActivity.ProvinceCode;
                break;
            case "4"://企业新闻
                str = URL + "?KeyNo=" + KeyNo + "&pripid=" + pripid + "&regno=" + regno + "&priptype=" + priptype + "&entname=" + entname + "&devicetype=1&provinceCode="+CompanyDetailsActivity.ProvinceCode;
                break;
            ...
            case "7"://首页招投标
                ...
                str=URL+"?token="+"202cb962ac59075b964b07152d234b70"+"&KeyNo="+KeyNo+"&deviceId=123"+"&pageSize=20&pageIndex=0"+"&devicetype=1";
                break;
            case "8"://首页商标详情
            ...
            case"11"://投资全景
                ...
                str = URL + "?KeyNo=" + KeyNo + "&priptype=" + priptype+"&entname="+entname+"&regno="+regno+"&devicetype=1&provinceCode="+CompanyDetailsActivity.ProvinceCode ;
                break;
