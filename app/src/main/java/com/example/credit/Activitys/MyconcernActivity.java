...
public class MyconcernActivity extends BaseActivity {
    ...
    public void init() {
        ...
        adapter = new Myconcer_listAdapter(MyconcernActivity.this, DataManager.FavotiteListS.data.followInfo);
        if ( DataManager.FavotiteListS.data.followInfo!=null && DataManager.FavotiteListS.data.followInfo.size()>0) {
        ...
        mycconn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                wd.show();
                positions = position;
                String KeyNo = DataManager.FavotiteListS.data.followInfo.get(position).PRIPID;//市场主体身份代码
