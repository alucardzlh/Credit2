...
public class Obeyed_Adapter extends BaseAdapter {
    Context context;
    List<DataManager.obeyedMar.DataBean.KchcInfoBean> advertisementList;

    public Obeyed_Adapter(Context context, List<DataManager.obeyedMar.DataBean.KchcInfoBean> advertisementList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            DataManager.obeyedMar.DataBean.KchcInfoBean temp=advertisementList.get(position);
