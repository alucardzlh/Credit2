    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (st){
            case 1:
                ...
                Honor_CAdapter hcadapter1=new Honor_CAdapter(Honor_Support_Activity.this, DataManager.honorMarList.data.honorInfo);
                hListView1.setAdapter(hcadapter1);
                break;
            case 2:
                b_topname.setText(Tname);
               Support_CAdapter hcadapter2=new Support_CAdapter(Honor_Support_Activity.this, DataManager.supportInfoS.data.supportInfo);
