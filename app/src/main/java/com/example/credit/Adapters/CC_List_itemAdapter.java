...
public class CC_List_itemAdapter extends BaseAdapter {
    ...
    public CC_List_itemAdapter(Context context, List<String> list, String str, List<String> imgUrl, List<String> list2) {
...
//            vh.im.setVisibility(View.VISIBLE);
            ...
            switch (position) {
                case 0:
                    vh.cl_tv1.setText(list.get(position) + "(" + DataManager.JudicialDocumentsMarList.data.judgmentInfo.size() + ")");
                    break;
                case 1:
                    vh.cl_tv1.setText(list.get(position) + "(" + DataManager.JudicialDocumentsMarList.data.courtcaseInfo.size() + ")");
                    break;
                case 2:
                    vh.cl_tv1.setText(list.get(position) + "(" + DataManager.JudicialDocumentsMarList.data.sfAlter.size() + ")");
                    break;
                case 3:
                    vh.cl_tv1.setText(list.get(position) + "(" + DataManager.JudicialDocumentsMarList.data.sfInfo.size() + ")");
                    break;

            }
        } else if (str.equals("copyright")) {//著作f权
            vh.punlic_1.setVisibility(View.GONE);
            vh.punlic_2.setVisibility(View.VISIBLE);
            vh.cl2_tv1.setText(list.get(position));
            vh.cl2_tv2.setText(imgUrl.get(position));
            vh.cl2_tv3.setText(list2.get(position));
...
//            vh.cl_tv2.setText(list.get(position));
            ...
            vh.year_time.setText(DataManager.ZZGSModels.data.anbaseInfo.get(position).ANCHEDATE);
        }
        return view;
    }
