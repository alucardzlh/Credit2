...
public class Judicial_CActivity extends BaseActivity {
    ...
    public void init(){
        ...
        if (state.equals(list1.get(0))){
            adapter=new JudicialAdapter(Judicial_CActivity.this, DataManager.JudicialDocumentsMarList.data.judgmentInfo,null,null,null,list1);
        }else if (state.equals(list2.get(0))){
            adapter=new JudicialAdapter(Judicial_CActivity.this, null,DataManager.JudicialDocumentsMarList.data.courtcaseInfo,null,null,list2);
        }else if (state.equals(list3.get(0))){
            adapter=new JudicialAdapter(Judicial_CActivity.this, null,null,DataManager.JudicialDocumentsMarList.data.sfAlter,null,list3);
        }else if (state.equals(list4.get(0))){
            adapter=new JudicialAdapter(Judicial_CActivity.this,null,null,null,DataManager.JudicialDocumentsMarList.data.sfInfo,list4);
        }
