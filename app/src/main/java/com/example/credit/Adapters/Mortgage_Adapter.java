...
public class Mortgage_Adapter extends BaseAdapter {
    Context context;
    List<DataManager.Mychattel.DataBean.MortregInfoBean> listMP;//动产数据源
//    List<DataManager.MyrealEstate.DataBean.realEstateBean> listRE;//不动产数据源

    public Mortgage_Adapter(Context context,  List<DataManager.Mychattel.DataBean.MortregInfoBean> listMP) {
...
//        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DataManager.Mychattel.DataBean.MortregInfoBean tempMP = new DataManager.Mychattel.DataBean.MortregInfoBean();
//        DataManager.MyrealEstate.DataBean.realEstateBean tempRE = new DataManager.MyrealEstate.DataBean.realEstateBean();
//        if(listRE!=null){
//            tempRE = listRE.get(position);
//        }else {
