...
public class Main_NewCliam_MoreListActivity extends BaseActivity {
    ...
    public static List<DataManager.NewClaimUtils.DataBean.ClaimInfoBean> MyCliamListMore = new ArrayList<>();//初始最新认领集合
        ...
        tListViewNC.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (csp.getLoginStatus()) {
                    ad.show();
                    falg=true;
                    String KeyNo = DataManager.NewClaimUtilsList.data.claimInfo.get(position).PRIPID;//市场主体身份代码
