...
public class NewClaimListAdapter extends BaseAdapter{
    Context context;
    List<DataManager.NewClaimUtils.DataBean.ClaimInfoBean> newsList;
    int st;
    public NewClaimListAdapter(Context context, List<DataManager.NewClaimUtils.DataBean.ClaimInfoBean> newsList,int sts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        vh.newclaim_1.setText(newsList.get(position).ENTNAME);
