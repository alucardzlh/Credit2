...
public class WebAutonomy extends BaseActivity {
    ...
    WebView web_conten;
    String KeyNo,devicetype,infoname,infotype,priptypes;
    ...
    private void init() {
        ...
        priptypes="&priptype="+in.getStringExtra("priptype");
        ...
        web_conten.loadUrl(Url+KeyNo+devicetype+priptypes+"&provinceCode"+CompanyDetailsActivity.ProvinceCode);
