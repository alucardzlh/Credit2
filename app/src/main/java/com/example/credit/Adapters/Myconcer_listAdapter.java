...
public class Myconcer_listAdapter extends BaseAdapter {
    ...
    private List<DataManager.FavotiteList.DataBean.FollowInfoBean> list;
    ViewHolder vh = null;
    public Myconcer_listAdapter(Context context, List<DataManager.FavotiteList.DataBean.FollowInfoBean> list) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        DataManager.FavotiteList.DataBean.FollowInfoBean ab=list.get(position);
        vh.mycon_name.setText(ab.ENTNAME+"");
        vh.mycon_Faname.setText(ab.NAME+"");
        vh.mycon_zcmoney.setText(ab.REGNORE+"");
        vh.mycon_zcdate.setText(ab.CREATETIME+"");
        return view;
    }
