...
public class Commment_ItemlistAdapter extends BaseAdapter {
    ...
    private List<DataManager.MyCommentlistr.DataBean.CommentInfoBean.CommentSonInfoBean> list;
    ViewHolder vh = null;
    public Commment_ItemlistAdapter(Context context, List<DataManager.MyCommentlistr.DataBean.CommentInfoBean.CommentSonInfoBean> list) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        vh.pli_name.setText(list.get(position).MEMBERNAME);
        vh.pli_time.setText(list.get(position).CREATETIME);
        vh.pli_content.setText(list.get(position).CONTENT);
        return view;
    }
