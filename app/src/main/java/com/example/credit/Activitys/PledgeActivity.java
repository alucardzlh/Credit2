...
public class PledgeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (DataManager.pledgeMar.DataBean.PledgeInfoBean p : DataManager.pledgeMarList.data.pledgeInfo) {
            list.add(p.EQUITYNO);
        }
        CC_List_itemAdapter adapter = new CC_List_itemAdapter(PledgeActivity.this, list, "pledge", null,null);
