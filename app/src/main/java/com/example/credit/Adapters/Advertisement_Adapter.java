...
public class Advertisement_Adapter extends BaseAdapter {
    Context context;
    List<DataManager.advertisementMar.DataBean.AdvertisingInfoBean> advertisementList;

    public Advertisement_Adapter(Context context, List<DataManager.advertisementMar.DataBean.AdvertisingInfoBean> advertisementList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            DataManager.advertisementMar.DataBean.AdvertisingInfoBean temp=advertisementList.get(position);
