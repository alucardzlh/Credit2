...
public class Mortgage_detail_Fragment extends Fragment {
    ...
    List<DataManager.Mychattel.DataBean.MortregInfoBean> listMP;
//    List<DataManager.MyrealEstate.DataBean.realEstateBean> listRE;
    ...
    public void setListData(List<DataManager.Mychattel.DataBean.MortregInfoBean> listMP1){
        this.listMP=listMP1;
//        this.listRE=listRE;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new Mortgage_Adapter(getActivity(), listMP);
...
//        listRE=DataManager.MyrealEstateS.data.realEstate;
        listMP=DataManager.MychattelS.data.mortregInfo;
    }
