    ...
    private void initview() {
        ...
        switch (value){
            case "企业年报":
                ...
                autoAdapter.setData(DataManager.ZZGSModels.data.anbaseInfo,null,null,null,null,null);
                report_lv.setAdapter(autoAdapter);
                autoAdapter.notifyDataSetChanged();
                report_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        startActivity(new Intent(Autonomy_Detail_Activity.this,WebAutonomy.class).putExtra("KeyNo", DataManager.ZZGSModels.data.anbaseInfo.get(position).ANCHEID));
                    }
                });
                break;
            case "股东及出资":
                ...
                lore.setVisibility(View.GONE);
                punish.setVisibility(View.GONE);
                autoAdapter.setData(null,DataManager.ZZGSModels.data.shareholdersandInvestment,null,null,null,null);
            ...
            case "股权变更":
                ...
                lore.setVisibility(View.GONE);
                punish.setVisibility(View.GONE);
                autoAdapter.setData(null,null,DataManager.ZZGSModels.data.anSubcapitalInfo,null,null,null);
            ...
            case "行政许可":
                ...
                lore.setVisibility(View.GONE);
                punish.setVisibility(View.GONE);
                autoAdapter.setData(null,null,null,DataManager.ZZGSModels.data.eimpermitInfo,null,null);
            ...
            case"知识产权登记":
                ...
                punish.setVisibility(View.GONE);
                autoAdapter.setData(null,null,null,null,DataManager.ZZGSModels.data.eimippldgInfo,null);
            ...
            case"行政处罚":
                ...
                autoAdapter.setData(null,null,null,null,null,DataManager.ZZGSModels.data.eimcaseInfo);
