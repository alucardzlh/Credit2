...
public class AbnormalAdapter extends BaseAdapter {
    ...
    private List<DataManager.abnormalInfo.DataBean.AnomaliesInfoBean> list;

    public AbnormalAdapter(Context context, List<DataManager.abnormalInfo.DataBean.AnomaliesInfoBean> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            vh = new ViewHolder();
            vh.a_tv0=(TextView) view.findViewById(R.id.a_tv0);
            vh.a_tv1=(TextView) view.findViewById(R.id.a_tv1);
            vh.a_tv2=(TextView) view.findViewById(R.id.a_tv2);
            vh.a_tv6=(TextView) view.findViewById(R.id.a_tv6);
