...
public class Public_Detail_ctivity extends BaseActivity {
    ...
    public void init() {
        ...
        if (state.equals("patent")) {//专利
            ...
            list1.add(DataManager.punishMarDriList.data.otCaseInfo.get(position).PENDECNO);
            list1.add(DataManager.punishMarDriList.data.otCaseInfo.get(position).ENTNAME);
            list1.add(DataManager.punishMarDriList.data.otCaseInfo.get(position).UNISCID);
            list1.add(DataManager.punishMarDriList.data.otCaseInfo.get(position).DWFDDBR);
            list1.add(DataManager.punishMarDriList.data.otCaseInfo.get(position).ILLEGACTTYPE);
