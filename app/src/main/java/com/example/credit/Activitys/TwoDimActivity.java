...
public class TwoDimActivity extends BaseActivity {
    ...
    public void init() {
        file1 = new File(Environment.getExternalStorageDirectory() + "/Credit/cache/"+DataManager.QJiugongGList.data.baseInfo.get(0).REGNO+"_TwoDimImg.jpg");
...
//                }
                //把字节数组的图片写到另一个地方
                File apple = new File(Environment.getExternalStorageDirectory() + "/Credit/cache/"+DataManager.QJiugongGList.data.baseInfo.get(0).REGNO+"_TwoDimImg.jpg");
    ...
    View.OnClickListener listener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.xiazai:
                    String strD = Environment.getExternalStorageDirectory() + "/Credit/TwoDimImg/" + DataManager.QJiugongGList.data.baseInfo.get(0).ENTNAME + "_TwoDimImg.jpg";
