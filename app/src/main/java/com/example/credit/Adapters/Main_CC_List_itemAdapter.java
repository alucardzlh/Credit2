...
//            vh.im.setVisibility(View.VISIBLE);
            ...
            if(DataManager.ZZQModelsList.data.workCopyrightInfo.size()>0) {
                if (DataManager.ZZQModelsList.data.workCopyrightInfo.get(position).WORKCLASS.equals("")) {
                    vh.cl2_tv3.setText("软件");
                } else {
                    vh.cl2_tv3.setText(DataManager.ZZQModelsList.data.workCopyrightInfo.get(position).WORKCLASS);
                }
            }else{
                vh.cl2_tv3.setText("软件");
            }
...
//            vh.cl_tv2.setText(list.get(position));
        ...
        }else if (str.equals("Dishonesty")) {//失信人
            vh.punlic_1.setVisibility(View.GONE);
            vh.public_5.setVisibility(View.VISIBLE);
            vh.sx_1.setText(list.get(position));
            vh.sx_1.setTextAppearance(context, R.style.VariableName);
