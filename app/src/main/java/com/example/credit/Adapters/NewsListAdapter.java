...
public class NewsListAdapter extends BaseAdapter{
    Context context;
    List<DataManager.MyNews.DataBean.NewInformationBean> newsList;
    public NewsListAdapter(Context context, List<DataManager.MyNews.DataBean.NewInformationBean> newsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DataManager.MyNews.DataBean.NewInformationBean tempNews=newsList.get(position);
