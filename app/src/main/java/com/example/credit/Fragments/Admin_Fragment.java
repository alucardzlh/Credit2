...
public class Admin_Fragment extends Fragment {
    ...
    List<DataManager.Admin.DataBean.LicCertificateBean> amdinList;
    ...
    public void setListData(List<DataManager.Admin.DataBean.LicCertificateBean> amdinList,List<DataManager.Admin.DataBean.OtPermitBean> otherList){
